              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <div className="grid grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={i} className={`p-4 rounded-2xl ${kpi.bg} border border-transparent hover:border-slate-200 transition-all text-center`}><p className="text-[10px] font-bold uppercase text-slate-400 mb-1">{kpi.label}</p><p className={`text-2xl font-black ${kpi.color}`}>{kpi.val}</p></div>
                  ))}
                </div>
            ...
            {activeTab === 'docs' && (
              <div className="space-y-6">
                ...
                <div className="space-y-3 pt-4">
                  <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-3 flex items-center gap-2"><BookOpen size={14} className="text-indigo-500" /> Semilleros Vinculados</h4>
