...
$BackendRunning = Test-Port "127.0.0.1" 8000
if ($BackendRunning) {
...
$FrontendRunning = Test-Port "127.0.0.1" 3001
if ($FrontendRunning) {
...
"@ | Set-Content $ViteConfig -Encoding UTF8
    ...
    $FrontendProcess = Start-Process -FilePath "cmd.exe" -ArgumentList "/c", "npm run dev -- --port 3001 --strictPort --host 127.0.0.1" -WorkingDirectory $RootDir -WindowStyle Hidden -PassThru
...
$BackendOk = Test-Port "127.0.0.1" 8000
$FrontendOk = Test-Port "127.0.0.1" 3001
...
Write-Host ""
Write-Status "Presiona cualquier tecla para salir..." $Cyan
